  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Container(
        ...
        child: Selector<HLSPlayerStore, Tuple2<Map<String, HMSHLSLayer>, int>>(
          selector: (_, hlsPlayerStore) =>
              Tuple2(hlsPlayerStore.layerMap, hlsPlayerStore.layerMap.length),
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      const Row(children: [HMSCrossButton()]),
                    ],
                  ),
                  Padding(
                        ...
                        return GestureDetector(
                          ...
                          child: ListTile(
                            ...
                            title: HMSSubtitleText(
                              text: data.item1.entries.elementAt(index).key,
                              fontSize: 14,
                              lineHeight: 20,
                              letterSpacing: 0.10,
