  ...
  void _navigateToMeeting(PreviewStore previewStore) {
    ...
    Navigator.of(context).pushReplacement(MaterialPageRoute(
        builder: (context) => MeetingScreenController(
              ...
              initialIsVideoOn: previewStore.isVideoOn,
              initialIsAudioOn: previewStore.isAudioOn,
            )));
  }
                                      ...
                                      child: (previewStore.isVideoOn)
                                          ? Center(
                                              child: HMSTextureView(
                                                ...
                                                // Only mirror if front camera is active
                                                // Back camera should not be mirrored so text appears correctly
                                                setMirror: previewStore
                                                    .isFrontCameraActive,
                                              ),
                                            )
                                          : Center(
